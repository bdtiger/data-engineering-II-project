...
\begin{itemize}
  \item \textbf{get\_predictions()}: Batch inference on all 1{,}000 repositories, returns predicted vs actual stars with repository names
