...
instance_prod = nova.servers.create(name="group_5_prod_server_"+str(identifier), image=image, flavor=flavor, key_name=KEY_NAME,userdata=userdata_prod, nics=nics,security_groups=secgroups)
instance_dev = nova.servers.create(name="group_5_dev_server_"+str(identifier), image=image, flavor=flavor, key_name=KEY_NAME,userdata=userdata_dev, nics=nics,security_groups=secgroups)
